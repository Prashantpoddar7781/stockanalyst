...
// EXPANDED LIST: NIFTY 500 & Popular Stocks
export const NSE_STOCKS: Stock[] = [
  ...
  { symbol: 'CESC', name: 'CESC Ltd', sector: 'Power & Utilities' },
  { symbol: 'JSWENERGY', name: 'JSW Energy Ltd', sector: 'Power & Utilities' },
  { symbol: 'TORNTPOWER', name: 'Torrent Power Ltd', sector: 'Power & Utilities' },
  { symbol: 'IEX', name: 'Indian Energy Exchange Ltd', sector: 'Power & Utilities' },
  { symbol: 'MANAPPURAM', name: 'Manappuram Finance Ltd', sector: 'Banking & Financials' },
  { symbol: 'MUTHOOTFIN', name: 'Muthoot Finance Ltd', sector: 'Banking & Financials' },
  { symbol: 'UJJIVANSFB', name: 'Ujjivan Small Finance Bank Ltd', sector: 'Banking & Financials' },
  { symbol: 'EQUITASBNK', name: 'Equitas Small Finance Bank Ltd', sector: 'Banking & Financials' },
  { symbol: 'KARURVYSYA', name: 'The Karur Vysya Bank Ltd', sector: 'Banking & Financials' },
  { symbol: 'CUB', name: 'City Union Bank Ltd', sector: 'Banking & Financials' },
  { symbol: 'FEDERALBNK', name: 'The Federal Bank Ltd', sector: 'Banking & Financials' },
  { symbol: 'INDIANB', name: 'Indian Bank', sector: 'Banking & Financials' },
  { symbol: 'MAHABANK', name: 'Bank of Maharashtra', sector: 'Banking & Financials' },
  { symbol: 'IOB', name: 'Indian Overseas Bank', sector: 'Banking & Financials' },
  { symbol: 'UCOBANK', name: 'UCO Bank', sector: 'Banking & Financials' },
  { symbol: 'CENTRALBK', name: 'Central Bank of India', sector: 'Banking & Financials' },
  { symbol: 'LICHSGFIN', name: 'LIC Housing Finance Ltd', sector: 'Banking & Financials' },
  { symbol: 'PNBHOUSING', name: 'PNB Housing Finance Ltd', sector: 'Banking & Financials' },
  { symbol: 'HUDCO', name: 'Housing & Urban Development Corporation Ltd', sector: 'Banking & Financials' },
  { symbol: 'IFCI', name: 'IFCI Ltd', sector: 'Banking & Financials' },
  { symbol: 'GSFC', name: 'Gujarat State Fertilizers & Chemicals Ltd', sector: 'Agriculture' },
  { symbol: 'GNFC', name: 'Gujarat Narmada Valley Fertilizers & Chemicals', sector: 'Agriculture' },
  { symbol: 'RCF', name: 'Rashtriya Chemicals and Fertilizers Ltd', sector: 'Agriculture' },
  { symbol: 'DEEPAKFERT', name: 'Deepak Fertilisers and Petrochemicals Corp', sector: 'Chemicals' },
  ...
  { symbol: 'AETHER', name: 'Aether Industries Ltd', sector: 'Chemicals' },
  { symbol: 'ANURAS', name: 'Anupam Rasayan India Ltd', sector: 'Chemicals' },
  { symbol: 'LAXMICHEM', name: 'Laxmi Organic Industries Ltd', sector: 'Chemicals' },
  ...
  { symbol: 'IREDA', name: 'Indian Renewable Energy Development Agency', sector: 'Banking & Financials' },
  { symbol: 'DOMS', name: 'DOMS Industries Ltd', sector: 'FMCG & Consumer Goods' },
  { symbol: 'RRKABEL', name: 'R R Kabel Ltd', sector: 'Capital Goods' },
  { symbol: 'CELLO', name: 'Cello World Ltd', sector: 'FMCG & Consumer Goods' },
  { symbol: 'HONASA', name: 'Honasa Consumer Ltd', sector: 'FMCG & Consumer Goods' },
  { symbol: 'BIKAJI', name: 'Bikaji Foods International Ltd', sector: 'FMCG & Consumer Goods' },
  { symbol: 'GLOBAL', name: 'Global Health Ltd', sector: 'Pharma & Healthcare' },
  { symbol: 'FIVESTAR', name: 'Five-Star Business Finance Ltd', sector: 'Banking & Financials' },
  { symbol: 'MEDPLUS', name: 'Medplus Health Services Ltd', sector: 'Retail & E-commerce' },
  { symbol: 'CAMPUS', name: 'Campus Activewear Ltd', sector: 'Retail & E-commerce' },
  { symbol: 'GOCOLORS', name: 'Go Fashion (India) Ltd', sector: 'Retail & E-commerce' },
  { symbol: 'MAPMYINDIA', name: 'C.E. Info Systems Ltd', sector: 'Information Technology' },
  { symbol: 'RATEGAIN', name: 'RateGain Travel Technologies Ltd', sector: 'Information Technology' },
  { symbol: 'LATENTVIEW', name: 'Latent View Analytics Ltd', sector: 'Information Technology' },
  { symbol: 'HAPPSTMNDS', name: 'Happiest Minds Technologies Ltd', sector: 'Information Technology' },
  { symbol: 'ROUTE', name: 'Route Mobile Ltd', sector: 'Information Technology' },
  ...
  { symbol: 'INTELLECT', name: 'Intellect Design Arena Ltd', sector: 'Information Technology' },
  { symbol: 'SONATSOFTW', name: 'Sonata Software Ltd', sector: 'Information Technology' },
  { symbol: 'FIRSTSOURCE', name: 'Firstsource Solutions Ltd', sector: 'Information Technology' },
  { symbol: 'BSL', name: 'Bhansali Engineering Polymers Ltd', sector: 'Chemicals' },
  ...
  { symbol: 'MAHSEAMLES', name: 'Maharashtra Seamless Ltd', sector: 'Metals & Mining' },
  { symbol: 'GMDC', name: 'Gujarat Mineral Development Corporation Ltd', sector: 'Metals & Mining' },
  { symbol: 'MOIL', name: 'MOIL Ltd', sector: 'Metals & Mining' },
  { symbol: 'KIOCL', name: 'KIOCL Ltd', sector: 'Metals & Mining' },
  { symbol: 'GPPL', name: 'Gujarat Pipavav Port Ltd', sector: 'Logistics' },
  { symbol: 'MAHLOG', name: 'Mahindra Logistics Ltd', sector: 'Logistics' },
  { symbol: 'VRLLOG', name: 'VRL Logistics Ltd', sector: 'Logistics' },
  { symbol: 'TCIEXP', name: 'TCI Express Ltd', sector: 'Logistics' },
  ...
  { symbol: 'HEMIPROP', name: 'Hemisphere Properties India Ltd', sector: 'Real Estate' },
  { symbol: 'PVR', name: 'PVR INOX Ltd', sector: 'Media & Entertainment' },
  { symbol: 'NETWORK18', name: 'Network18 Media & Investments Ltd', sector: 'Media & Entertainment' },
  { symbol: 'TV18BRDCST', name: 'TV18 Broadcast Ltd', sector: 'Media & Entertainment' },
  { symbol: 'DBC', name: 'D.B. Corp Ltd', sector: 'Media & Entertainment' },
  { symbol: 'JAGRAN', name: 'Jagran Prakashan Ltd', sector: 'Media & Entertainment' },
  { symbol: 'NAZARA', name: 'Nazara Technologies Ltd', sector: 'Media & Entertainment' },
  { symbol: 'SAREGAMA', name: 'Saregama India Ltd', sector: 'Media & Entertainment' },
  { symbol: 'TIPSIND', name: 'Tips Industries Ltd', sector: 'Media & Entertainment' },
  { symbol: 'JUBLPHARMA', name: 'Jubilant Pharmova Ltd', sector: 'Pharma & Healthcare' },
  { symbol: 'WOCKPHARMA', name: 'Wockhardt Ltd', sector: 'Pharma & Healthcare' },
  { symbol: 'STRIDES', name: 'Strides Pharma Science Ltd', sector: 'Pharma & Healthcare' },
  { symbol: 'MARKSANS', name: 'Marksans Pharma Ltd', sector: 'Pharma & Healthcare' },
  { symbol: 'GRANULES', name: 'Granules India Ltd', sector: 'Pharma & Healthcare' },
  { symbol: 'ERIS', name: 'Eris Lifesciences Ltd', sector: 'Pharma & Healthcare' },
  { symbol: 'CAPLIPOINT', name: 'Caplin Point Laboratories Ltd', sector: 'Pharma & Healthcare' },
  { symbol: 'FDC', name: 'FDC Ltd', sector: 'Pharma & Healthcare' },
  { symbol: 'BLUESTARCO', name: 'Blue Star Ltd', sector: 'Capital Goods' },
  { symbol: 'JOHNSONCON', name: 'Johnson Controls-Hitachi Air Conditioning', sector: 'Capital Goods' },
  ...
  { symbol: 'VIPIND', name: 'VIP Industries Ltd', sector: 'FMCG & Consumer Goods' },
  { symbol: 'SAFARI', name: 'Safari Industries (India) Ltd', sector: 'FMCG & Consumer Goods' },
  { symbol: 'JYOTHYLAB', name: 'Jyothy Labs Ltd', sector: 'FMCG & Consumer Goods' },
  { symbol: 'EMAMILTD', name: 'Emami Ltd', sector: 'FMCG & Consumer Goods' },
  { symbol: 'GILLETTE', name: 'Gillette India Ltd', sector: 'FMCG & Consumer Goods' },
  { symbol: 'PGHH', name: 'Procter & Gamble Hygiene and Health Care Ltd', sector: 'FMCG & Consumer Goods' },
  { symbol: 'GODFRYPHRP', name: 'Godfrey Phillips India Ltd', sector: 'FMCG & Consumer Goods' },
  { symbol: 'VSTIND', name: 'VST Industries Ltd', sector: 'FMCG & Consumer Goods' },
  { symbol: 'CCL', name: 'CCL Products (India) Ltd', sector: 'FMCG & Consumer Goods' },
  { symbol: 'TASTYBITE', name: 'Tasty Bite Eatables Ltd', sector: 'FMCG & Consumer Goods' },
  { symbol: 'RENUKA', name: 'Shree Renuka Sugars Ltd', sector: 'FMCG & Consumer Goods' },
  { symbol: 'BALRAMCHIN', name: 'Balrampur Chini Mills Ltd', sector: 'FMCG & Consumer Goods' },
  { symbol: 'TRIVENI', name: 'Triveni Engineering & Industries Ltd', sector: 'FMCG & Consumer Goods' },
  { symbol: 'EIDPARRY', name: 'E.I.D. - Parry (India) Ltd', sector: 'FMCG & Consumer Goods' },
  { symbol: 'PRAIGIND', name: 'Praj Industries Ltd', sector: 'Capital Goods' },
  ...
  { symbol: 'KALPATPOWR', name: 'Kalpataru Projects International Ltd', sector: 'Capital Goods' },
  { symbol: 'TECHNOE', name: 'Techno Electric & Engineering Company Ltd', sector: 'Capital Goods' },
  { symbol: 'ENGINERSIN', name: 'Engineers India Ltd', sector: 'Infra & Construction' },
  { symbol: 'JBCHEPHARM', name: 'J.B. Chemicals & Pharmaceuticals Ltd', sector: 'Pharma & Healthcare' },
  { symbol: 'AJANTPHARM', name: 'Ajanta Pharma Ltd', sector: 'Pharma & Healthcare' },
  { symbol: 'ALEMBICLTD', name: 'Alembic Pharmaceuticals Ltd', sector: 'Pharma & Healthcare' },
  { symbol: 'POLICYBZR', name: 'PB Fintech Ltd', sector: 'Banking & Financials' },
  { symbol: 'NYKAA', name: 'FSN E-Commerce Ventures Ltd', sector: 'Retail & E-commerce' },
  { symbol: 'ZOMATO', name: 'Zomato Ltd', sector: 'Retail & E-commerce' },
  { symbol: 'PAYTM', name: 'One 97 Communications Ltd', sector: 'Banking & Financials' },
  { symbol: 'DELHIVERY', name: 'Delhivery Ltd', sector: 'Logistics' },
  { symbol: 'CARTRADE', name: 'CarTrade Tech Ltd', sector: 'Retail & E-commerce' },
  { symbol: 'EASEMYTRIP', name: 'Easy Trip Planners Ltd', sector: 'Retail & E-commerce' },
  { symbol: 'YATRA', name: 'Yatra Online Ltd', sector: 'Retail & E-commerce' },
  { symbol: 'IDEA', name: 'Vodafone Idea Ltd', sector: 'Telecom' },
  { symbol: 'GTLINFRA', name: 'GTL Infrastructure Ltd', sector: 'Telecom' },
  ...
  { symbol: 'SUNDARAM', name: 'Sundaram Multi Pap Ltd', sector: 'Cement & Materials' },
  { symbol: 'STARCEMENT', name: 'Star Cement Ltd', sector: 'Cement & Materials' },
  { symbol: 'HEIDELBERG', name: 'HeidelbergCement India Ltd', sector: 'Cement & Materials' },
  { symbol: 'ORIENTCEM', name: 'Orient Cement Ltd', sector: 'Cement & Materials' },
  { symbol: 'JKPAPER', name: 'JK Paper Ltd', sector: 'Cement & Materials' },
  { symbol: 'WESTCOAST', name: 'West Coast Paper Mills Ltd', sector: 'Cement & Materials' },
  { symbol: 'ANDHRAPAP', name: 'Andhra Paper Ltd', sector: 'Cement & Materials' },
  { symbol: 'SESHAPAPER', name: 'Seshasayee Paper and Boards Ltd', sector: 'Cement & Materials' },
  { symbol: 'TNPL', name: 'Tamil Nadu Newsprint & Papers Ltd', sector: 'Cement & Materials' },
  { symbol: 'KALYANKJIL', name: 'Kalyan Jewellers India Ltd', sector: 'Retail & E-commerce' },
  { symbol: 'RAJESHEXPO', name: 'Rajesh Exports Ltd', sector: 'Retail & E-commerce' },
  { symbol: 'VAIBHAVGBL', name: 'Vaibhav Global Ltd', sector: 'Retail & E-commerce' },
  { symbol: 'THANGAMAYL', name: 'Thangamayil Jewellery Ltd', sector: 'Retail & E-commerce' },
  { symbol: 'PCJEWELLER', name: 'PC Jeweller Ltd', sector: 'Retail & E-commerce' },
  { symbol: 'SENCO', name: 'Senco Gold Ltd', sector: 'Retail & E-commerce' },
  { symbol: 'CAMS', name: 'Computer Age Management Services Ltd', sector: 'Banking & Financials' },
  { symbol: 'CDSL', name: 'Central Depository Services (India) Ltd', sector: 'Banking & Financials' },
  { symbol: 'BSE', name: 'BSE Ltd', sector: 'Banking & Financials' },
  { symbol: 'MCX', name: 'Multi Commodity Exchange of India Ltd', sector: 'Banking & Financials' },
  { symbol: 'ISEC', name: 'ICICI Securities Ltd', sector: 'Banking & Financials' },
  { symbol: 'ANGELONE', name: 'Angel One Ltd', sector: 'Banking & Financials' },
  { symbol: 'MOTILALOFS', name: 'Motilal Oswal Financial Services Ltd', sector: 'Banking & Financials' },
  { symbol: 'IIFL', name: 'IIFL Finance Ltd', sector: 'Banking & Financials' },
  { symbol: 'JM_FINANC', name: 'JM Financial Ltd', sector: 'Banking & Financials' },
  { symbol: 'EDELWEISS', name: 'Edelweiss Financial Services Ltd', sector: 'Banking & Financials' },
  { symbol: 'GEOJITFSL', name: 'Geojit Financial Services Ltd', sector: 'Banking & Financials' },
  { symbol: 'CENTURYTEX', name: 'Century Textiles & Industries Ltd', sector: 'Textiles' },
  { symbol: 'KSL', name: 'Kalyani Steels Ltd', sector: 'Metals & Mining' },
  { symbol: 'JSL', name: 'Jindal Stainless Ltd', sector: 'Metals & Mining' },
  { symbol: 'WELENT', name: 'Welspun Enterprises Ltd', sector: 'Infra & Construction' },
  { symbol: 'UDS', name: 'Updater Services Ltd', sector: 'Services' },
  { symbol: 'TEAMLEASE', name: 'TeamLease Services Ltd', sector: 'Services' },
  { symbol: 'QUESS', name: 'Quess Corp Ltd', sector: 'Services' },
  { symbol: 'SIS', name: 'SIS Ltd', sector: 'Services' },
  { symbol: 'BLS', name: 'BLS International Services Ltd', sector: 'Services' },
  { symbol: 'CMSINFO', name: 'CMS Info Systems Ltd', sector: 'Services' },
  { symbol: 'REDINGTON', name: 'Redington Ltd', sector: 'Information Technology' },
  { symbol: 'RSYSTEMS', name: 'R Systems International Ltd', sector: 'Information Technology' },
  { symbol: 'NEWGEN', name: 'Newgen Software Technologies Ltd', sector: 'Information Technology' },
  { symbol: 'DATAPATTNS', name: 'Data Patterns (India) Ltd', sector: 'Defence' },
  { symbol: 'MTARTECH', name: 'MTAR Technologies Ltd', sector: 'Defence' },
  { symbol: 'PARAS', name: 'Paras Defence and Space Technologies Ltd', sector: 'Defence' },
  { symbol: 'ASTRAMICRO', name: 'Astra Microwave Products Ltd', sector: 'Defence' },
  { symbol: 'ZENTECH', name: 'Zen Technologies Ltd', sector: 'Defence' },
  { symbol: 'IDEAFORGE', name: 'ideaForge Technology Ltd', sector: 'Defence' },
  { symbol: 'AZAD', name: 'Azad Engineering Ltd', sector: 'Defence' },
  { symbol: 'JUPITER', name: 'Jupiter Wagons Ltd', sector: 'Capital Goods' },
  { symbol: 'TITAGARH', name: 'Titagarh Rail Systems Ltd', sector: 'Capital Goods' },
  { symbol: 'TEXRAIL', name: 'Texmaco Rail & Engineering Ltd', sector: 'Capital Goods' },
  { symbol: 'RKFORGE', name: 'Ramkrishna Forgings Ltd', sector: 'Capital Goods' },
  { symbol: 'ELECTCAST', name: 'Electrosteel Castings Ltd', sector: 'Capital Goods' },
  { symbol: 'GPIL', name: 'Godawari Power & Ispat Ltd', sector: 'Metals & Mining' },
  { symbol: 'JAYNECOIND', name: 'Jayaswal Neco Industries Ltd', sector: 'Metals & Mining' },
  { symbol: 'USHAMART', name: 'Usha Martin Ltd', sector: 'Metals & Mining' },
  { symbol: 'TATAINVEST', name: 'Tata Investment Corporation Ltd', sector: 'Banking & Financials' },
  { symbol: 'MAHESHWARI', name: 'Maheshwari Logistics Ltd', sector: 'Logistics' },
  { symbol: 'LLOYDSME', name: 'Lloyds Metals and Energy Ltd', sector: 'Metals & Mining' },
  { symbol: 'JAICORPLTD', name: 'Jai Corp Ltd', sector: 'Metals & Mining' },
  { symbol: 'SWANENERGY', name: 'Swan Energy Ltd', sector: 'Textiles' },
  { symbol: 'GANESHHOUC', name: 'Ganesh Housing Corporation Ltd', sector: 'Real Estate' },
  { symbol: 'ANANTRAJ', name: 'Anant Raj Ltd', sector: 'Real Estate' },
  { symbol: 'PURVA', name: 'Puravankara Ltd', sector: 'Real Estate' },
  { symbol: 'KOLTEPATIL', name: 'Kolte-Patil Developers Ltd', sector: 'Real Estate' },
  { symbol: 'ASHIANA', name: 'Ashiana Housing Ltd', sector: 'Real Estate' },
  { symbol: 'MAZDOCK', name: 'Mazagon Dock Shipbuilders Ltd', sector: 'Defence' },
  ...
  { symbol: 'AVANTIFEED', name: 'Avanti Feeds Ltd', sector: 'Agriculture' },
  { symbol: 'VENKYS', name: 'Venky\'s (India) Ltd', sector: 'Agriculture' },
  { symbol: 'GODREJAGRO', name: 'Godrej Agrovet Ltd', sector: 'Agriculture' },
  { symbol: 'HATSUN', name: 'Hatsun Agro Product Ltd', sector: 'FMCG & Consumer Goods' },
  { symbol: 'DODLA', name: 'Dodla Dairy Ltd', sector: 'FMCG & Consumer Goods' },
  { symbol: 'HERITGFOOD', name: 'Heritage Foods Ltd', sector: 'FMCG & Consumer Goods' },
  { symbol: 'VADILALIND', name: 'Vadilal Industries Ltd', sector: 'FMCG & Consumer Goods' },
  { symbol: 'PARAGMILK', name: 'Parag Milk Foods Ltd', sector: 'FMCG & Consumer Goods' },
  { symbol: 'KRBL', name: 'KRBL Ltd', sector: 'FMCG & Consumer Goods' },
  { symbol: 'LTFOODS', name: 'LT Foods Ltd', sector: 'FMCG & Consumer Goods' },
  { symbol: 'CHAMANSEQ', name: 'Chaman Lal Setia Exports Ltd', sector: 'FMCG & Consumer Goods' },
  { symbol: 'GRSE', name: 'Garden Reach Shipbuilders & Engineers Ltd', sector: 'Defence' },
];
